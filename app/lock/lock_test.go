...
func TestLock_FileBasic(t *testing.T) {
...
func TestLock_DirBasic(t *testing.T) {
...
func TestLock_FileErrorPropagation(t *testing.T) {
	filePath := createTestFile(t)
...
func TestLock_DirErrorPropagation(t *testing.T) {
	dirPath := createTestDir(t)
...
func TestLock_ConcurrentLockFile(t *testing.T) {
	filePath := createTestFile(t)
...
func TestLock_ConcurrentLockDir(t *testing.T) {
	dirPath := createTestDir(t)
